            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">A dynamic agency
                                    <span>That specializes in software consultancy</span>
                                </h1>
                                <p class="lead  text-white">We are a team of seasoned developers with extensive experience in creating cutting-edge industrial software solutions.</p>
                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">Artificial Intelligence (AI)</h6>
                                    <p class="description mt-3">In the realm of Artificial Intelligence, we harness the power of advanced algorithms and machine learning to create intelligent solutions that optimize processes, enhance user experiences, and drive business growth. 
                                        Our team of AI experts is dedicated to exploring innovative ways to leverage technology for your benefit.</p>
                                    <div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-success text-uppercase">Search Engine Optimization (SEO)</h6>
                                    <p class="description mt-3">When it comes to Search Engine Optimization, we understand the importance of online visibility in today's digital landscape. Our SEO specialists employ strategic techniques to boost your website's rankings, increase organic traffic, and maximize your online presence. 
                                        We stay updated with the latest search engine algorithms to ensure your business stays ahead of the competition.</p>
                                    <div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-warning text-uppercase">Architecture</h6>
                                    <p class="description mt-3">In the field of Architecture, we blend creativity and functionality to design spaces that inspire and captivate. Whether you need architectural consultations, interior design expertise, or project management, our team of skilled architects and designers are here to turn your vision into reality. 
                                        We believe in creating spaces that not only reflect your personality but also optimize functionality and aesthetic appeal.</p>
                                    <div>
                ...
                <div class="row row-grid align-items-center">
                    ...
                    <div class="col-md-6 order-md-1">
                        <div class="pr-md-5">
                            ...
                            <p>we understand the importance of providing exceptional service tailored to your unique needs. 
                                We believe in building lasting relationships with our customers, and your satisfaction is our top priority..</p>
                            <ul class="list-unstyled mt-5">
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-settings-gear-65"></badge>
                                        <h6 class="mb-0">Carefully crafted features</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-html5"></badge>
                                        <h6 class="mb-0">Amazing comunication</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                ...
                <div class="row row-grid align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="pl-md-5">
                            ...
                            <h3>Our customers</h3>
                            <p class="lead">Our team of experts is ready to listen and understand your specific requirements. 
                                We take pride in offering personalized solutions that address your challenges and align with your goals.</p>
                            <p>Your feedback matters. By reaching out to us, you contribute to our ongoing efforts to enhance and improve our offerings.
                                 Your insights help us better serve you and all our valued customers.</p>
                            <p>Stay in the loop with the latest developments, promotions, and exclusive offers by staying connected. 
                                By reaching out to us, you ensure that you're among the first to know about exciting opportunities..</p>
                        </div>
                    </div>
                </div>
            </div>
